...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[UINavigationBar appearance] setBackgroundColor:[UIColor flatDarkBlackColor]];
    
    //[[UIView appearance] setBackgroundColor:[UIColor flatDarkBlueColor]];
    
    // Turn on location manager if it doesn't exist
